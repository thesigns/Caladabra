...
public static class CardDefinitions
{
    ...
    private static void RegisterSaltyCards(CardRegistry registry)
    {
        ...
        // Po zagraniu: Tłuszcz -6, odrzuć 1 kartę ze Stołu
        registry.Register(new Card
        {
            ...
            Instruction = "Po zagraniu tej karty redukujesz Tłuszcz o 6 i odrzucasz 1 dowolną kartę ze Stołu do Kibelka.",
            OnPlay = new Sequence(
                new ReduceFat(6),
        ...
        // Po zagraniu: Tłuszcz -7, połóż na stole na 3 tury.
        // Jeśli usuniesz wcześniej ze stołu, Tłuszcz -7 dodatkowo.
        registry.Register(new Card
        {
            ...
            Instruction = "Po zagraniu tej karty redukujesz Tłuszcz o 7. Połóż tę kartę na stole na 3 tury. Jeśli usuniesz ją wcześniej ze stołu, redukujesz Tłuszcz dodatkowo o 7.",
            OnPlay = new Sequence(
                new ReduceFat(7),
                new PlaceOnTable(3)
            ),
            OnLeaveTable = new ReduceFat(7)
        });

        // Łowca dwóch smaków - SW:5, Kal:1
        // Po zagraniu: za każdą słodką/kwaśną w Żołądku -5 Tłuszczu, potem opróżnij Żołądek
        registry.Register(new Card
        {
            ...
            Instruction = "Po zagraniu policz wszystkie słodkie i kwaśne karty w Żołądku. Za każdą z nich redukujesz Tłuszcz o 5. Potem opróżniasz zawartość Żołądka do Kibelka.",
            OnPlay = new Sequence(
    ...
    private static void RegisterSweetCards(CardRegistry registry)
    {
        ...
        // Po zagraniu: za każdą gorzką kartę w Ręce/Żołądku/Stole +2 SW
        registry.Register(new Card
        {
            Id = "lizak_na_oslode",
            ...
            Instruction = "Po zagraniu tej karty za każdą gorzką kartę w Ręce, Żołądku i na Stole dostajesz 2 punkty SW.",
    ...
    private static void RegisterBitterCards(CardRegistry registry)
    {
        ...
        // Po zagraniu: połóż na Stole, po 3 turach wróć na wierzch Spiżarni, -3 SW, +1 Tłuszcz
        registry.Register(new Card
        {
        ...
        // Dostawa jedzenia - SW:1, Kal:6
        // Po zagraniu: wybierz gorzką kartę z Listy Kart Caladabra, dodaj do Ręki, +1 Tłuszcz
        registry.Register(new Card
        {
            Id = "dostawa_jedzenia",
            ...
            Instruction = "Po zagraniu tej karty zamiast dobierać kartę ze Spiżarni wybierz dowolną gorzką kartę z Listy Kart Caladabra i dodaj ją do Ręki oraz dodaj 1 Tłuszczu.",
            OnPlay = new Sequence(
                new ChooseCardFromZone(
                    ZoneType.CardList,
    ...
    {
        // Łapczywe jedzenie - SW:6, Kal:5
        // Po zagraniu: przenieś 1 kartę z Ręki do Żołądka, dobierz kartę, -2 Tłuszcz jeśli była słona
        registry.Register(new Card
        {
        ...
        // Grzebanie w kibelku - SW:8, Kal:4
    ...
    private static void RegisterSourCards(CardRegistry registry)
    {
        ...
        registry.Register(new Card
        {
            ...
            Instruction = "Po zagraniu tej karty połóż ją na Stole na 3 tury. Przez 3 tury jeśli w Żołądku znajduje się karta o smaku słodkim i kwaśnym – zyskujesz 8 SW. W przeciwnym razie – tracisz 2 SW i zyskujesz 2 Tłuszczu.",
            OnPlay = new PlaceOnTable(3),
        ...
        // Po zagraniu: połóż na Stole. Co turę: jeśli 3 różne smaki w Żołądku -> +3 SW -4 Tłuszcz
        ...
        registry.Register(new Card
        {
            ...
            Instruction = "Po zagraniu połóż tę kartę na Stole. W każdej turze, w której w Żołądku masz 3 różne Smaki, dostajesz +3 SW i redukujesz 4 Tłuszcze. W przeciwnym wypadku tracisz 2 SW i przybierasz 4 Tłuszcze.",
        ...
        // Po zagraniu: połóż na Stole. Po 2 turach: jeśli 3 różne smaki na Stole -> +8 SW -5 Tłuszcz
        ...
        registry.Register(new Card
        {
            ...
            Instruction = "Po zagraniu tej karty połóż ją na Stole. Po 2 turach: jeśli na Stole będą 3 różne Smaki, zyskujesz 8 SW i redukujesz 5 Tłuszczu. Jeśli nie — tracisz 5 SW. Tak czy inaczej usuń tę kartę ze Stołu.",
            OnPlay = new PlaceOnTable(2),
